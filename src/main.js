...
cardHolder.addEventListener("input", () => {
  ...
  ccHolder.innerText =
    cardHolder.value.length === 0 ? "what your name?" : cardHolder.value
})
...
function updateSecurityCode(code) {
  ...
  ccSecurity.innerText = code.length === 0 ? "XXXX" : code
}
